package com.simple.TestDemoProject;
...
public class TransactionJdbc {
	...
	private static final String DB_CONNECTION = "jdbc:postgresql://10.133.35.57:5432/EmployeeInfoDb";
	...
	public static void main(String[] argv) throws SQLException {
		...
		try {
			...
			preparedStatementInsert.setTimestamp(3,  getCurrentTimeStamp());
			...
			preparedStatementUpdate.setInt(3, 999);
